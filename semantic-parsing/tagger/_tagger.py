class _Tagger:
    ...
    PRECEDENCE_NUMBER_UNIT = 95
    PRECEDENCE_RANGE = 94          # around 100k USD
    
    PRECEDENCE_MULTIPLICATION = 93
    PRECEDENCE_DIVISION = PRECEDENCE_MULTIPLICATION
    PRECEDENCE_REMAINDER = PRECEDENCE_MULTIPLICATION
    
    PRECEDENCE_ADDITION = 92
    PRECEDENCE_SUBTRACTION = PRECEDENCE_ADDITION
